...
write.csv(vif_df, "test-outputs/main_model-vif_results.csv", row.names = FALSE)
...
colnames(vif_df) <- "VIF"
vif_df$Variable <- rownames(vif_df)
write.csv(vif_df, "test-outputs/sub_model_1-vif_results.csv", row.names = FALSE)
...
colnames(vif_df) <- "VIF"
vif_df$Variable <- rownames(vif_df)
write.csv(vif_df, "test-outputs/sub_model_2-vif_results.csv", row.names = FALSE)
...
colnames(vif_df) <- "VIF"
vif_df$Variable <- rownames(vif_df)
write.csv(vif_df, "test-outputs/sub_model_3-vif_results.csv", row.names = FALSE)